...
export class ProfileComponent implements OnInit {
  ...
  async imprimir(data: any){
   ...
   // pdf.pageMargins([ 8, 8, 10, 10 ]);
    ...
    pdf.add( new Txt('---------------------------------------------------------------------------------------------------').alignment('center').italics().end);
    //pdf.add(new Txt('PAGO: ' + data.estadoRegistro).alignment('center').italics().end);
    pdf.add(new Txt('PAGO: ' + (data.estadoRegistro === 'CONFIRMADO' ? 'CONFIRMADO' : 'PENDIENTE DE PAGO')).alignment('center').italics().end);
    pdf.add( new Txt('---------------------------------------------------------------------------------------------------').alignment('center').italics().end);
